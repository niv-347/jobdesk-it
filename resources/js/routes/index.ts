 ...
 * @route '/sop'
 */
    const sopForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: sop.url(options),
        method: 'get',
    })
 ...
 * @route '/sop'
 */
        sopForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: sop.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/sop'
 */
        sopForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: sop.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/konfigurasi'
 */
    const konfigurasiForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: konfigurasi.url(options),
        method: 'get',
    })
 ...
 * @route '/konfigurasi'
 */
        konfigurasiForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: konfigurasi.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/konfigurasi'
 */
        konfigurasiForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: konfigurasi.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    konfigurasi.form = konfigurasiForm